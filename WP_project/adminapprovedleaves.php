...
{	
$sql="SELECT users.id,users.First_Name,users.Last_Name,users.Loginid,tbleaves.LeaveType,tbleaves.FromDate,tbleaves.ToDate,tbleaves.Description,tbleaves.PostingDate,tbleaves.Status,tbleaves.empid FROM tbleaves INNER JOIN users on tbleaves.empid=users.id AND tbleaves.Status=1";
...
<img src="aditya.png" >
  ...
  <a  class="active" href="adminapprovedleaves.php">Approved Leaves</a>
